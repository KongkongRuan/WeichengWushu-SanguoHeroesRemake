 ...
 *    3. void startGameThread() — 启动游戏线程 (VF L15268, javap L44128)
 *    4. void loadRMS_sfSmsInfo() — RMS读取"__sfSmsInfo" (VF L15313, javap L44161)
 *    5. void processSaveBuffer() — 存档缓冲区处理 (VF L15744, 部分恢复)
 *
...
//      6. hex解码: 每2字节→1字节, 使用clearScreen()函数 (offset 627-722)
...
// ============================================================================
// 3. void startGameThread() — 启动游戏线程 (javap L44128-44161)
//
//    Vineflower 失败原因:
...
// ============================================================================
// 4. void loadRMS_sfSmsInfo() — RMS读取"__sfSmsInfo" (javap L44161-44520)
//
//    Vineflower 失败原因:
...
//    175: invokespecial saveRMS_sfSmsInfo()    // 调用ax()写入默认值
