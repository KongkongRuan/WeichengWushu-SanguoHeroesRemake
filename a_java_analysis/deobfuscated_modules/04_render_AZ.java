...
//    private void A()
//
//    根据 m1033(场景模式) 和 l(游戏状态) 分发到对应渲染方法:
//    m1033!=0: 调用 w() (特殊模式)
//
//    l(状态)分发:
...
//    - 3: ak()+Y()+ag()+H()+j()+c(3,-1)
//    - 4/20: a(b1015[1])+c(-1,1) (版权文本)
//    - 5/21: a(b1015[0])+c(-1,1) (说明文本)
//    - 8: a(true)+c(3,-1) (帮助页1)
...
private void A() {
    ...
    if (var5) {
        ...
        switch (var5) {
            case 0:
                ...
                if (var5 == var4) {
                    ...
                    if (logo != null) {
                        ...
                        this.a1002.drawImage(logo, x, y, 0);
                    }
                }
                break;
            case 19:
            ...
            case 4:
            case 20:
                this.a(this.b1015[var2]);
                if (this.l == 20) {
                    int x = 240 - this.a1013[4][25].getWidth() >> 1;
                    this.c(5, x, 0);
                }
                this.c(var3, var2);
                break;
...
private final void X() {
    ...
    // 胜利条件检查
    if (this.l == 2 && this.aP <= 0 && this.aT == this.aX && this.g1046 == 35) {
        this.p1078 = true;
    }
