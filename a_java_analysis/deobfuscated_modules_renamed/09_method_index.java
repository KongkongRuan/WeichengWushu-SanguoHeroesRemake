 ...
 * 方法 | 返回类型 | 功能                              | VF行号 | 来源
 * -----|----------|----------------------------------|--------|-----
 * dispatchRender()  | void     | 渲染分发器 (switch l)             | 4741   | [VF]
 * runLoadProcess()  | void     | 加载流程 (e/c调用链)              | 5443   | [VF]
 * saveRMS_sanGuoTd()  | void     | RMS 存档保存 "sanGuoTd"           | 5620   | [VF]
 * loadRMS_sanGuoTdData()  | void     | RMS 存档读取 "sanGuoTdData"       | 6668   | [VF]
 * loadRMS_freeGame()  | void     | RMS 存档读取 "freeGame"           | 7035   | [VF]
 * loopProcess15()  | void     | 循环处理(15次)                    | 7270   | [VF]
 * updateMainFrame()  | void     | ★主帧更新逻辑 (状态机分发)        | 7309   | [VF]
 * drawScrollAndBg()  | void     | 调用 calcScrollPosition()+drawBackground()                      | 7771   | [VF]
 * drawBackground()  | void     | 背景绘制                          | 7784   | [VF]
 * calcScrollPosition()  | void     | 滚动计算                          | 7856   | [VF]
 * handleLevelSelect()  | void     | 关卡选择 (switch aw)              | 8146   | [VF]
 * handleLevelInput()  | void     | 输入处理 (switch keyState)           | 8219   | [VF]
 * handleTechTree()  | void     | 科技树                            | 8273   | [VF]
 * iterateTileProperties()  | void     | 遍历 tileProperties 数组                   | 8469   | [VF]
 * updateGameState()  | void     | ★游戏状态更新 (aS/aR/aT)          | 8518   | [VF]
 * selectGeneral()  | void     | 武将选择 (generalSelectData)                  | 8568   | [VF]
 * selectGeneralAlt()  | void     | 武将选择 (同P)                    | 8592   | [VF]
 * advanceLevel()  | void     | 关卡推进 (levelAdvanceFlag)                  | 8633   | [VF]
 * renderOverlay()  | void     | 渲染 (renderFlag)                      | 8768   | [VF]
 * checkVictory()  | void     | 胜利检查 (aT==aX)                 | 8868   | [VF]
 * resetGame()  | void     | 初始化 (aq,aw=0,bg=0)             | 8903   | [VF]
 * iteratePaths()  | void     | 遍历 bf                           | 8955   | [VF]
 * drawMainMap()  | void     | 地图主绘制 (825行)                | 9023   | [VF]
 * updateGameFrame()  | void     | ★★主游戏帧更新                    | 9224   | [VF]
 * renderGameWorld()  | void     | 渲染 (renderData,towerSlots)                | 9590   | [VF]
 * renderGeneralSelect()  | void     | 渲染 (bn)                         | 9926   | [VF]
 */
 ...
 * 方法  | 返回类型 | 功能                           | VF行号 | 来源
 * ------|----------|-------------------------------|--------|-----
 * helperAA()  | void     | [?]                           | 13349  | [VF]
 * helperAB()  | void     | [?]                           | 13419  | [VF]
 * helperAC()  | void     | [?]                           | 13437  | [VF]
 * helperAD()  | void     | [?]                           | 13492  | [VF]
 * helperAE()  | void     | [?]                           | 13555  | [VF]
 * helperAF()  | void     | [?]                           | 13574  | [VF]
 * renderAG_block298()  | void     | [?] (298行)                   | 13592  | [VF]
 * helperAH()  | void     | [?]                           | 13890  | [VF]
 * helperAI()  | void     | [?]                           | 13975  | [VF]
 * helperAJ()  | void     | [?]                           | 14081  | [VF]
 * renderAK_block297()  | void     | [?] (297行)                   | 14159  | [VF]
 * renderAL_block235()  | void     | [?] (235行)                   | 14456  | [VF]
 * helperAM()  | void     | [?]                           | 14691  | [VF]
 * helperAN()  | void     | [?]                           | 14739  | [VF]
 * dispatchKeyState()  | void     | ★按键状态机分发 (switch l)     | 14790  | [VF]
 * renderDifficulty()  | void     | 渲染 (gameTexts[175])              | 14870  | [VF]
 * handleInputAQ()  | void     | 输入处理 (switch keyState)        | 14936  | [VF]
 * renderEndingAnim()  | void     | 渲染 (结局动画)                | 15006  | [VF]
 * stateMachineNotify()  | void     | 状态机 (switch notifyStatus)          | 15082  | [VF]
 * setNotify1()  | void     | 设置b1174=1                    | 15239  | [VF]
 * initCalendar()  | void     | 日历初始化                     | 15244  | [VF]
 * startGameThread()  | void     | ★启动游戏线程                  | 15268  | [BC]
 * loadRMS_sfSmsInfo()  | void     | ★RMS读取"__sfSmsInfo"          | 15313  | [BC]
 * saveRMS_sfSmsInfo()  | void     | RMS写入"__sfSmsInfo"           | 15473  | [VF]
 * processSaveBuffer()  | void     | 存档缓冲区处理                 | 15744  | [VF]
 */
 ...
 * a(int)                            | int      | 瓦片属性 tileProperties[n]>>1    | 9997   | [VF]
 ...
 * calcBaseHp(int,int,int)    | int      | 静态-计算                  | 18663  | [VF]
 * d()               | void     | 建造菜单背景               | 18667  | [VF]
 * d(int)            | void     | 背景卷轴绘制               | 18699  | [VF]
 * d(int,int)        | void     | [?]                         | 18719  | [VF]
 * calcBaseHp(int,int,int)    | void     | [?]                         | 18758  | [VF]
 * calcBaseHp(int,int,int,int)| void     | [?]                         | 18772  | [VF]
 * calcBaseHp(int,int,int,int,int) | void| [?]                        | 18876  | [VF]
 * calcBaseHp(int,...,6参数)  | void     | [?]                         | 18882  | [VF]
 * calcBaseHp(Image,int,int,int) | void  | [?]                         | 18997  | [VF]
...
/**
 * ============================================================================
 * H. clearScreen()-updateEnemyMovement() 方法 — 模块 06/07
 * ============================================================================
 *
 * 方法              | 返回类型 | 功能                        | VF行号 | 来源
 * ------------------|----------|----------------------------|--------|-----
 * e(int)            | int      | 静态-计算                  | 19228  | [VF]
 * clearScreen()               | void     | 清屏                        | 19257  | [VF]
 ...
 * clearScreen()               | boolean  | 科技树全解锁检查           | 19432  | [VF]
 * e(int)            | boolean  | 敌人检查                   | 19455  | [VF]
 * e(int,int)        | boolean  | 瓦片==8检查                | 19613  | [VF]
 * drawProgressBar()               | void     | ★进度条渲染                | 19628  | [VF]
 * f(int)            | void     | [?]                         | 19681  | [VF]
 ...
 * handleVolumeInput()               | void     | 输入处理                   | 21989  | [VF]
 ...
 *   - c()系列: 17个
 *   - d()系列: 14个
 *   - clearScreen()-updateEnemyMovement()系列: ~100个
 *
 * Vineflower成功: ~145个 (97%)
 * Vineflower失败: 5个 (3%) — b()/d()/startGameThread()/loadRMS_sfSmsInfo()/processSaveBuffer()
 * 字节码恢复: 5个 (100%)
 * ============================================================================
 */
