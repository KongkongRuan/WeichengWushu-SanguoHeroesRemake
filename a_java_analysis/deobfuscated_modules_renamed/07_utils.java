...
private void renderScrollText(String var1) {
    ...
    this.drawTextPanel(var1, var2, 27, 18, 186, 292);  // 调用文字面板绘制
}
...
private final void drawTextPanel(String var1, int var2, int var3, int var4, int var5, int var6) {
    ...
    this.renderChars(chars, len, var2, var3, var4, var5, var6, needScroll);
}
...
private void drawImageTiled(Image var1, int var2, int var3, int var4, int var5) {
    ...
    this.drawImageRotation(var1, var2 + var4 - imgW, var3, 1);           // 水平翻转
    this.drawImageRotation(var1, var2, var3 + var5 - imgH, 2);            // 垂直翻转
    this.drawImageRotation(var1, var2 + var4 - imgW, var3 + var5 - imgH, 3); // 180°
}
