...
private final Font gameFont;                    // a: 游戏字体 Font.getFont(32,0,8)
...
private final int fontHeight;                     // j: 字体高度 gameFont.getHeight()
private final int charWidth;                     // k: 字符宽度 gameFont.charWidth('口')
private final int lineHeight;                     // n: 行高 fontHeight + 2

// ============================================================================
// 3. 屏幕尺寸 (final, 构造函数计算)
// ============================================================================

private final int screenWidth;                     // V: 屏幕宽度 (字体高度×3+40 ≈240)
private final int screenHeight;                     // W: 屏幕高度相关
private final int tileSize;                    // ad: 瓦片大小 字体高度×3+40
private final int mapCols;                    // ah: 地图列数 字体高度×3+10+30
private final int mapRows;                    // ai: 地图行数 ah+40
private final int mapColsExtended;                    // aj: MAP_COLS+13+10
...
private int gameState;                           // l: 当前游戏状态 (核心状态机变量)
private int menuDepth;                           // m: 菜单栈深度
private int[] menuHistoryStack;                         // b: 菜单历史栈 int[10]
private int selectedTowerIdx;                           // o: 选中塔索引 (-1=未选中)
private int progressBarWidth;                           // p: 进度条宽度
private int volume;                           // q: 音量值
private int enemyCount;                           // r: 敌人数量
private int frameTimeStats;                           // s: 帧耗时统计
private int bgScrollOffset;                           // t: 背景偏移
...
public int cursorX;                            // c: 光标X
public int cursorY;                            // d: 光标Y
private int[] levelProgress;                         // e: 关卡进度 int[21]
...
private final int[] spriteFrameCounts;                   // f: 精灵帧数 int[39]
