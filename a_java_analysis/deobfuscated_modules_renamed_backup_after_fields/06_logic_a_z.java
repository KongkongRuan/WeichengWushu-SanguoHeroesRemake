...
private void d() {
    ...
    for (int i = 0; i < 10; i++) {
        ...
        this.a(this.spriteImages[3][25], 216, (i << 5) + 13, 1);
    }
}
...
private void d(int var1) {
    for (int i = 0; i < 3; i++) {
        this.graphicsCtx.drawImage(this.spriteImages[4][6], this.u + i * 176, this.v + var1, 0);
    }
}
...
private boolean d(int var1) {
    ...
    if (!pathVerified) {
        ...
        if (level < LEVEL_5) {
            ...
            int hp = this.a(var6[IDX_PATH], this.enemyHpCoeffs, var6[IDX_LEVEL]);
            if (this.j(hp)) {
                return true;
            }
            this.o = 0;
...
private boolean e(int var1) {
    ...
    int attackRange = this.a(var7[IDX_PATH], this.towerDamageRange, var7[IDX_LEVEL]);
        ...
        case 7:
            ...
            for (int i = 0; i < this.aP; i++) {
                ...
                if (this.a(tower[0], tower[TRUE], x, y, attackRange)) {
                    ...
                    if (f(tower[8])) {
                        // 计算对塔的伤害
                        int dmg = this.a(var7[IDX_PATH], this.towerAtkSpeed, var7[IDX_LEVEL]);
...
private void f() {
    if (this.frameCounter > this.targetFrame) {
        ...
        this.graphicsCtx.setColor(16580557);
        this.graphicsCtx.setClip(0, 0, 240, 320);
        this.graphicsCtx.fillRect(x, 310, this.p, 10);
        // ... 进度条图标绘制 (VF L19628)
    }
}
...
private void g() {
    switch (this.keyState) {
        ...
        case 54:
            ...
            this.volumeControl.setLevel(this.q);
            break;
        // ... (VF L20471)
    }
}
...
private void s() {
    this.b(this.ad, 13);
    this.a(this.spriteImages[3][4], 0, 0, 13450878, true);
    // ... (VF L24545)
}
...
private void v() {
    ...
    this.graphicsCtx.fillRect(0, 320 - this.ai - 10, 240, this.ai);
    // ... (VF L25285)
}
