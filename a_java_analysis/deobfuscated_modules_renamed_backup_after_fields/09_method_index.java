 ...
 * L()  | void     | 输入处理 (switch keyState)           | 8219   | [VF]
 * M()  | void     | 科技树                            | 8273   | [VF]
 * N()  | void     | 遍历 tileProperties 数组                   | 8469   | [VF]
 * O()  | void     | ★游戏状态更新 (aS/aR/aT)          | 8518   | [VF]
 * P()  | void     | 武将选择 (generalSelectData)                  | 8568   | [VF]
 * Q()  | void     | 武将选择 (同P)                    | 8592   | [VF]
 * R()  | void     | 关卡推进 (levelAdvanceFlag)                  | 8633   | [VF]
 * S()  | void     | 渲染 (renderFlag)                      | 8768   | [VF]
 ...
 * Y()  | void     | 渲染 (renderData,towerSlots)                | 9590   | [VF]
 ...
 * ap()  | void     | 渲染 (gameTexts[175])              | 14870  | [VF]
 * aq()  | void     | 输入处理 (switch keyState)        | 14936  | [VF]
 * ar()  | void     | 渲染 (结局动画)                | 15006  | [VF]
 * as()  | void     | 状态机 (switch notifyStatus)          | 15082  | [VF]
 ...
 * f()               | boolean  | 初始化 (aw+au+initialized=true)   | 20430  | [VF]
