...
/**
 * 终阶建筑绑定武将后的效果说明（b1015[122]-b1015[154]）。
 * 下标就是武将 id；原版通过 y1130[国家][建筑类型] 同时取得武将名和这里的说明。
 */
export const HERO_EFFECT_DESCRIPTIONS: readonly string[] = [
  '使所有塔攻击增加',
  '无视敌人防御',
  '无视敌人防御',
  '击中敌人同时减速',
